report 50012 "AGT Sales - Order Conf."
{
    Caption = 'AGT Sales - Confirmation';
    DefaultLayout = RDLC;
        ...
        dataitem(Header; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                var
                    myInt: Integer;
                begin
                    NoOfLoops := No_Of_Copies + 1;
                    CopyText1 := '';
                    SetFilter(Number, '%1..%2', 1, NoOfLoops);
                    OutputNo := 1;
                end;
            ...
            begin
                ...
                // CurrReport.FormatRegion := Language.GetFormatRegionOrDefault("Format Region"); //AGT_MD_111623, commented this is not supproted on runtime version 10
                ...
                BillTo[7] := "Bill-to Country/Region Code";
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    Caption = 'Options';
                    //AGT_MD_111623 ++
                    field(No_Of_Copies; No_Of_Copies)
                    {
                        ApplicationArea = all;
    ...
    var
        //AGT_MD_111623 ++
        NoOfLoops, No_Of_Copies, OutputNo : Integer;
        CopyText1: Text;
        ...
        LineAmtAfterInvDiscLbl: Label 'Payment Discount on GST';
        ...
        VATAmtSpecificationLbl: Label 'GST Amount Specification';
        VATAmtLbl: Label 'GST Amount';
        VATAmountLCYLbl: Label 'GST Amount (LCY)';
        VATBaseLbl: Label 'GST Base';
        VATBaseLCYLbl: Label 'GST Base (LCY)';
        VATClausesLbl: Label 'GST Clause';
        VATIdentifierLbl: Label 'GST Identifier';
        VATPercentageLbl: Label 'GST %';
    ...
    begin
        ...
        //LogInteraction := SegManagement.FindInteractionTemplateCode(Enum::"Interaction Log Entry Document Type"::"Sales Ord. Cnfrmn.") <> ''; //This is for latest version
    end;
