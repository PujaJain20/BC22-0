report 50004 "AGT Purchase order"
{

    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = all;
    RDLCLayout = 'AGT_PurchaseOrder1.rdl';
    DefaultLayout = RDLC;
    ...
    var
        ...
        VATAmountSpecificationLbl: Label 'GST Amount Specification in ';
        ...
        VATDiscountAmountCaptionLbl: Label 'Payment Discount on GST';
        ...
        PrepymtVATAmtSpecCaptionLbl: Label 'Prepayment GST Amount Specification';
        AmountCaptionLbl: Label 'Amount';
        PurchLineInvDiscAmtCaptionLbl: Label 'Invoice Discount Amount';
        SubtotalCaptionLbl: Label 'Subtotal';
        VATAmtLineVATCaptionLbl: Label 'GST %';
        VATAmtLineVATAmtCaptionLbl: Label 'GST Amount';
        VATAmtSpecCaptionLbl: Label 'GST Amount Specification';
        VATIdentifierCaptionLbl: Label 'GST Identifier';
        VATAmtLineInvDiscBaseAmtCaptionLbl: Label 'Invoice Discount Base Amount';
        VATAmtLineLineAmtCaptionLbl: Label 'Line Amount';
        VALVATBaseLCYCaptionLbl: Label 'GST Base';
        PricesInclVATtxtLbl: Label 'Prices Including GST';
        ...
        PricesIncludingVATCaptionLbl: Label 'Prices Including GST';
