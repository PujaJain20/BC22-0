report 50282 "SalesShipmentNA"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'LocalSalesShipment.rdl';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesShptLine; "Integer")
                    {
                        ...
                        begin
                            ...
                            // SalesShipmentLine.setrange(type, Type::Item);

                            if SalesShipmentLine.FindFirst() then
                                repeat
                                    if SalesShipmentLine."No." = "Sales Shipment Line"."No." then
                                        Tot := Tot + SalesShipmentLine.Quantity

                                    else
                                        Tot := SalesShipmentLine.quantity;
