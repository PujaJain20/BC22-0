report 50210 "Item Labels"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'LocalItemLabels.rdl';
    Caption = 'Item  Labels';
    ...
    begin
        ...
        BarcodeFontProvider := Enum::"Barcode Font Provider"::IDAutomation1D;
        BarcodeSymbology := Enum::"Barcode Symbology"::Code39;
        BarcodeString := ItemNo[2];
        BarcodeFontProvider.ValidateInput(BarcodeString, BarcodeSymbology);
        barcode2 := BarcodeFontProvider.EncodeFont(BarcodeString, BarcodeSymbology);
    end;
    ...
    begin
        ...
        BarcodeFontProvider.ValidateInput(BarcodeString, BarcodeSymbology);
        barcode3 := BarcodeFontProvider.EncodeFont(BarcodeString, BarcodeSymbology);
    end;
    // AGT_PJ_12/12/2023 --
