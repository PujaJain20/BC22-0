            ...
            group("F&unctions")
            {
                ...
                action(Sendapproval)
                {
                    ...
                    begin
                        ...
                        hyperlinkText := '<a href=' + 'http://localhost:8080/BC220/?company=CRONUS%20USA%2C%20Inc.&page=256' + '>' + 'Click this link to open Page</a>';
                        body := hyperlinkText;
                ...
                action(status)
                {
                    ...
                    begin
                        editablefield := true;
                        rec."Approver status" := editablefield;
